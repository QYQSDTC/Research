...
simDataDir = '/Users/ywang/Research/PULSARTIMING/MultiCW/simDataSKA_loc9/';
...
outDir = [simDataDir,filesep,'results_simDataSKA_loc9_AvPhaseC',filesep,'summary'];
mkdir(outDir);
inDataDir = [simDataDir,filesep,'results_simDataSKA_loc9_AvPhaseC'];
